...
export default function TermsPage() {
  ...
  const sections = [
    ...
    {
      id: 'products',
      titleKey: 'terms.s2.title',
      subsections: [
        {
          subtitleKey: 'terms.s3.title',
    ...
    {
      id: 'payment',
      titleKey: 'terms.s6.title',
      subsections: [
        {
          subtitleKey: 'terms.s7.title',
    ...
    {
      id: 'shipping',
      titleKey: 'terms.s11.title',
      subsections: [
        {
          subtitleKey: 'terms.s12.title',
    ...
    {
      id: 'intellectual',
      titleKey: 'terms.s16.title',
      subsections: [
        {
          subtitleKey: 'terms.s17.title',
    ...
    {
      id: 'limitations',
      titleKey: 'terms.s20.title',
      subsections: [
        {
          subtitleKey: 'terms.s21.title',
      ...
      <main className="min-h-screen bg-sacred-black">
        ...
        <section className="relative py-16 px-4 border-b border-gold/20">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <span className="text-gold">{t("terms.page.title")}</span> of Service
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
